...
with col2:
    ...
    fig_pie.update_traces(
        ...
        pull=[0.1 if i == monthly_data['Amount'].idxmax() else 0 for i in range(len(monthly_data))],
...
with col4:
    ...
    fig_area = px.area(
        ...
        title="",
        template='plotly_white',
        color_discrete_sequence=['#764ba7']
    )
...
with col_adv1:
    ...
    fig_cumulative.update_layout(
        xaxis_title="Bulan",
        yaxis_title="Pendapatan Kumulatif ($)",
        height=400
    )
...
with col_adv2:
    ...
    monthly_data['Above_Average'] = monthly_data['Performance'] > 0
    ...
    fig_performance = px.bar(
        ...
        title="",
        template='plotly_white',
        color_discrete_map={True: '#00b894', False: '#ff7675'}
    )
    
    fig_performance.update_layout(
        xaxis_title="Bulan",
        yaxis_title="Deviasi dari Rata-rata ($)",
        height=400,
        showlegend=False
    )
